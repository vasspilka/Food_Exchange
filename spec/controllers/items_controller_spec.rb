  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved item as @item" do
        ...
        post :create, {:item => { "donation" => "invalid value" }}, valid_session
        assigns(:item).should be_a_new(Item)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested item" do
        ...
        Item.any_instance.should_receive(:update).with({ "donation" => "" })
        put :update, {:id => item.to_param, :item => { "donation" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the item as @item" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Item.any_instance.stub(:save).and_return(false)
        put :update, {:id => item.to_param, :item => { "donation" => "invalid value" }}, valid_session
        assigns(:item).should eq(item)
      end
